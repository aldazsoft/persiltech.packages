...
| Versión | Cambios                                                                                                                                                                       |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1.6   | El `.nuspec` declara el repositorio, ahora público, y se activa SourceLink: el depurador del consumidor puede entrar al código fuente. El paquete estrena sus notas de versión, el soporte pasa a las incidencias de GitHub y el suelo de `Persiltech.UserServices.Abstractions` sube de 0.1.12 a 0.1.15. Sin cambios en la superficie pública. |
